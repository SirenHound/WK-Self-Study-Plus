...
function ConvertStorage(vocab){
    var vocab = vocab || localGet("User-Vocab") || [];
    var v = vocab.length;
    while (v--){
...
function parseString(strObj){
    ...
    try {
        ...
        if (e.name === "SyntaxError"){
            debugging&&console.log(strName + " is an ordinary string that cannot be parsed.");
            obj = strObj;
        }else{
            ...
            xhrk.onreadystatechange = function() {
                if (xhrk.readyState == 4){
                    ...
                    if (requestedItem === 'kanji'){
                        ...
                        debugging&&console.log(kanjiList);
...
document.addEventListener("DOMContentLoaded", function() {
                          ...
                          debugging&&console.log("Redirecting to https protocol");
